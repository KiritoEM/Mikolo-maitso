...
const Settings: React.FC = () => {
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Zone Salon • Dernière mise à jour: il y a 2 min
            </p>
          </div>
          <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div className="flex items-center justify-between mb-2">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Zone Cuisine • Dernière mise à jour: il y a 1 min
            </p>
          </div>
        </div>
      </div>
  ...
  const renderSection = () => {
    switch (activeSection) {
      ...
      case "connectivity":
        return renderConnectivitySection();
      case "appearance":
              ...
              <div className=" flex flex-col md:flex-row  justify-between p-8">
                <div className="md:w-1/2 mb-8 md-0 ">
                  <div className="relative">
                    <img src={LL} className="max-w-full h-auto" />
                  </div>
                  <br></br>
                  <h1 className="text-4xl font-bold">
                    Nous sommes <span className="text-green-500">des</span>{" "}
                    <span className="text-green-500">ISPM</span>iens
                  </h1>
                  <p className="mt-6 text-gray-700 text-lg">IGGLIA et ESIIA</p>
                </div>
                <div className="md:w-1/2 flex flex-col items-center">
                  <div className="relative">
                    <img src={ispm} className="max-w-full h-auto" />
                  </div>

                  <h1 className="text-4xl font-bold">
                    Meilleur <span className="text-green-500">ecole</span> en{" "}
                    <span className="text-green-500">INFORMATIQUE</span> dans
                    l'Ocean Indien
                  </h1>
                </div>
              </div>
